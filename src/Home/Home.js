      ...
      <section id="home">
        <div className="flex flex-col h-screen">
          <div className="w-screen">
            ...
            <p className="w-82 mt-3 mx-auto text-center text-white text-opacity-50 text-2xl font-medium">I'm a full stack software engineer and alumni from the University of Central Florida.</p>
          </div>
